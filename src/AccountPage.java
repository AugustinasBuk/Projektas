...
public class AccountPage extends JFrame {
    ...
    public AccountPage(String username, String password) throws Exception {
        ...
        setVisible(true);
        accountLabel.setFont(new Font("Times New Roman", Font.BOLD, 45));
        nameLabel.setText("Labas  " + username);
        ...
        changePassButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageLabel.setText("Slaptažodis pakeistas");
            }
        });
        ...
        clipboardButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                messageLabel.setText("Linkas nukopijuotas");
            }
        });
